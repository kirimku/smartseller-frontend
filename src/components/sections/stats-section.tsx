...
export const StatsSection = () => {
  return (
    <div className="px-6 -mt-8 relative z-10">
      <Card className="bg-gradient-card shadow-card border-gaming-card">
        <div className="p-6">
          {/* Points Balance */}
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-gaming-cyan/20 rounded-lg">
                <Coins className="w-5 h-5 text-gaming-cyan" />
              </div>
              <div>
                <p className="text-sm text-muted-foreground">Available Points</p>
                <p className="text-2xl font-bold text-gaming-cyan">12,450</p>
              </div>
            </div>
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-muted-foreground">
              2,450 XP until <span className="text-gaming-purple font-medium">Legend Tier</span>
            </p>
          </div>
        </div>
      </Card>
