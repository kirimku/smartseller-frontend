...
help: ## Show this help message
	@echo "$(GREEN)SmartSeller Frontend - Docker Deployment$(NC)"
...
docker-logs-app: ## View application logs only
	@docker-compose logs -f smartseller-frontend
...
docker-shell: ## Open shell in the running container
	@docker-compose exec smartseller-frontend sh
